...
describe('Person e2e test', () => {
  ...
  const personSample = { name: 'Infraestructura fuerza overriding' };
  ...
  describe('Person page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Person page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Person');
  ...
  describe('new Person page', () => {
    ...
    it('should create an instance of Person', () => {
      cy.get(`[data-cy="name"]`).type('extensible Ronda').should('have.value', 'extensible Ronda');
