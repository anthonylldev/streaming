package com.anthonylldev.streaming.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.anthonylldev.streaming.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.anthonylldev.streaming.repository.UserRepository.USERS_BY_EMAIL_CACHE);
